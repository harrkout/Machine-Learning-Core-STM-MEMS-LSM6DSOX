...
[**Abstract** [1](#_Toc119493230)](#_Toc119493230)

[1 **Equipment** [4](#equipment)](#equipment)

[1.1 **B-L072Z-LRWAN1** [4](#b-l072z-lrwan1)](#b-l072z-lrwan1)

[1.2 **X-NUCLEO-IKS01A3** [5](#x-nucleo-iks01a3)](#x-nucleo-iks01a3)

[1.3 **STEVAL-MKI197V1** [6](#steval-mki197v1)](#steval-mki197v1)

[2 **Hardware Synthesis** [7](#hardware-synthesis)](#hardware-synthesis)

[2.1 **Connection between B-L072Z-LRWAN1 and X-NUCLEO-IKS01A3**
[7](#connection-between-b-l072z-lrwan1-and-x-nucleo-iks01a3)](#connection-between-b-l072z-lrwan1-and-x-nucleo-iks01a3)

[2.2 **Connection between X-NUCLEO-IKS01A3 and STEVAL-MKI197V1**
[8](#connection-between-x-nucleo-iks01a3-and-steval-mki197v1)](#connection-between-x-nucleo-iks01a3-and-steval-mki197v1)

[2.3 **LSM6DSOX Sensor Initialization**
[8](#_Toc119493238)](#_Toc119493238)

[3 **Firmware and Software**
[9](#firmware-and-software)](#firmware-and-software)

[3.1 **Firmware** [9](#firmware)](#firmware)

[3.2 **Unicleo-GUI** [10](#_Toc119493241)](#_Toc119493241)

[3.3 **Unico-GUI** [10](#_Toc119493242)](#_Toc119493242)

[3.4 **Weka** [11](#_Toc119493243)](#_Toc119493243)

[4 **Implementation** [12](#implementation)](#implementation)

[4.1 **STM32CubeIDE** [12](#stm32cubeide)](#stm32cubeide)

[4.2 **Unicleo-GUI** [12](#unicleo-gui-1)](#unicleo-gui-1)

[4.3 **Machine Learning Core Example**
[15](#machine-learning-core-example)](#machine-learning-core-example)

[4.4 **Unico-GUI** [18](#unico-gui-1)](#unico-gui-1)

[4.5 **Weka** [21](#weka-1)](#weka-1)

[4.6 **Video Demonstration**
[27](#video-demonstration)](#video-demonstration)

[5 **Falling Detection Algorithm**
[28](#falling-detection-algorithm)](#falling-detection-algorithm)

[5.1 **Creation of Falling Detection Datasets**
[28](#creation-of-falling-detection-datasets)](#creation-of-falling-detection-datasets)

[5.2 **Project Equipment** [29](#project-equipment)](#project-equipment)

[5.3 **Video Demonstration**
[29](#video-demonstration-1)](#video-demonstration-1)

[5.4 **Possible Real-World Use Scenarios**
[30](#possible-real-world-use-scenarios)](#possible-real-world-use-scenarios)

[6 **Falling Detection Algorithm With NUCLEO-WL55JCx and SHUBv3**
[31](#falling-detection-algorithm-with-nucleo-wl55jcx-and-shubv3)](#falling-detection-algorithm-with-nucleo-wl55jcx-and-shubv3)

[6.1 **Equipment** [32](#equipment-1)](#equipment-1)

[6.2 **Decision Tree Generation**
[34](#decision-tree-generation)](#decision-tree-generation)

[6.2.1 **K-fold Cross-Validation**
[34](#k-fold-cross-validation)](#k-fold-cross-validation)

[6.2.2 **J48 Algorithm (also known as C4.5)**
[34](#j48-algorithm-also-known-as-c4.5)](#j48-algorithm-also-known-as-c4.5)

[6.3 **Performance** [36](#performance)](#performance)

[6.4 **Video Demonstration**
[36](#video-demonstration-2)](#video-demonstration-2)

[7 **References** [37](#references)](#references)
...
<img src="media/image1.jpeg" style="width:2.42708in;height:2.06944in" />**[B-L072Z-LRWAN1](https://www.st.com/en/evaluation-tools/b-l072z-lrwan1.html)  
**

<img src="media/image2.jpeg" style="width:1.67612in;height:2.84348in"
...
<img src="media/image3.jpeg" style="width:2.83158in;height:2.80208in"
...
<img src="media/image4.jpeg" style="width:2.65947in;height:1.96875in" />
...
<img src="media/image5.jpeg" style="width:4.32222in;height:5.90625in" />
...
<img src="media/image9.jpeg" style="width:3.23056in;height:3.84306in" />
...
**  
**<img src="media/image10.jpeg" style="width:5.025in;height:2.97083in" />
...
<img src="media/image11.jpeg" style="width:5.94375in;height:3.225in" />First,
...
<img src="media/image15.png" style="width:2.50417in;height:3.47431in" />The
...
<img src="media/image17.jpeg" style="width:5.75784in;height:3.23257in"
...
<img src="media/image21.png" style="width:4.09514in;height:3.14583in" />After
...
<img src="media/image22.png" style="width:6.02328in;height:3.56036in"
alt="Graphical user interface, table Description automatically generated" />

<img src="media/image23.png" style="width:5.86458in;height:3.42222in" />Then,
...
<img src="media/image24.png" style="width:5.60417in;height:3.30139in" />

<img src="media/image25.png" style="width:5.65145in;height:3.29564in" />
...
<img src="media/image26.png" style="width:6.49306in;height:3.85903in" />

## **Weka**

<img src="media/image27.png" style="width:4.42153in;height:3.32986in" />Open
...
<img src="media/image28.png" style="width:5.64306in;height:4.24375in" /><img src="media/image29.png" style="width:2.225in;height:3.79167in" />

<img src="media/image30.jpeg" style="width:6.1437in;height:3.36458in" />The
...
<img src="media/image31.png" style="width:3.85694in;height:3.1875in" />

And to see the ***Decision Tree***, right click on the ***Result List***
and select ***Visualize Tree***.

<img src="media/image32.png" style="width:5.64236in;height:4.23958in" />

<img src="media/image33.png" style="width:6.02083in;height:3.51042in" />Now
the **.txt** file can be loaded into the ***Unico*** window that was
left intact a while ago.

And save the file as ***sports.ucf***.

<img src="media/image34.png" style="width:5.84236in;height:3.41667in" />

<img src="media/image35.png" style="width:2.92708in;height:4.09653in" />Now
...
> <img src="media/image36.png" style="width:2.48819in;height:3.43472in" />

And here ***MLC0_SRC*** changes to ***2*** when the board mimics the
action for **Boxing**.

<img src="media/image37.png" style="width:2.6375in;height:3.72083in" />
...
> **<u>  
> </u>**<img src="media/image39.png" style="width:5.35631in;height:3.65903in" />**  
>   
> **
...
<img src="media/image42.png" style="width:4.18512in;height:3.13697in"
alt="A picture containing text, circuit, electronics Description automatically generated" />

-   WL55JCx + SensorHubV3 + MKI197v1

<img src="media/image43.png" style="width:4.51875in;height:4.27272in"
...
<img src="media/image44.png" style="width:6.26875in;height:3.4375in" />

*Below is the Decision Tree visualization offered by WEKA.*

<img src="media/image45.png" style="width:2.99004in;height:3.91467in"
